        ...
        <div class="block-slider block-slider4">
            <ul class="" id="bxslider-home4">
                <li>
                    ...
                    <?php echo Html::image('img/h4-slide.png', 'Slide'); ?>
                ...
                <li><?php echo Html::image('img/h4-slide2.png', 'Slide'); ?>
                ...
                <div class="col-md-12">
                    <div class="latest-product">
                        ...
                        <div class="product-carousel">
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="<?php echo e(asset("img/product-2.jpg")); ?>" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single_product.blade.php" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="<?php echo e(asset("img/product-3.jpg")); ?>" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single_product.blade.php" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="<?php echo e(asset("img/product-4.jpg")); ?>" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single_product.blade.php" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="<?php echo e(asset("img/product-5.jpg")); ?>" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single_product.blade.php" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="<?php echo e(asset("img/product-6.jpg")); ?>" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single_product.blade.php" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
